...
appcan.define("optionList", function (a, b, c) {
    ...
    i.prototype = {
        buildListview: function (b, c) {
            var d = a("<ul></ul>"), g = this, h = "hiddenLine" == g.option.type ? f : f;
            for (var i in b) {
                var j = a(h({data: b[i], option: g.option, index: i, group: c}));
            ...
            var k = 0, l = 0, m = 0, n = 0, o = a(".scrollRight").width(), p = 0, q = !0, r = 0, s = !1;
            ...
            return a(document).on("touchstart", ".scroll-bar", function (b) {
                if (1 == e && appcan.window.disableBounce(), !g.option.multiShow) {
                    ...
                    a(".scroll-bar").not(this).css({"-webkit-transition-duration": "100ms", marginLeft: 0})
                }
                q = !0, r = 0;
                var d = b.touches[0];
                k = d.pageX, l = d.pageY, m = d.pageX, n = d.pageY, p = parseInt(a(this)[0].style.marginLeft), o = a(this).siblings(".scroll-right").width(), a(".scroll-bar").css({"-webkit-transition-duration": "0s"})
            }), a(document).on("touchmove", ".scroll-bar", function (b) {
                if (0 != q) {
                    var c = b.touches[0];
                    m = c.pageX, n = c.pageY, isNaN(p) && (p = 0);
                    var d = p + m - k;
                    if (d = 0 > d ? d : 0, 0 == r) {
                        var f = {x: k, y: l}, g = {x: m, y: n}, h = t(f, g);
                        if (r = 1, parseInt(h) < -30 || parseInt(h) > 30) 1 == e && appcan.window.enableBounce(), q = !1; else {
                            if (parseInt(a(this)[0].style.marginLeft) > 0)return;
                            a(this).css({"-webkit-transition-duration": "0s", marginLeft: d}), b.preventDefault()
                        }
                    } else {
                        if (0 == q)return;
                        if (parseInt(a(this)[0].style.marginLeft) > 0)return;
                        a(this).css({"-webkit-transition-duration": "0s", marginLeft: d})
                    }
                }
                ...
                1 == e && appcan.window.enableBounce(), q && a(this).css(k - m > o / 2 ? {
                    ...
                    marginLeft: -o
                } : {"-webkit-transition-duration": g.option.duration, marginLeft: 0})
                ...
                k = d.pageX, l = d.pageY, m = d.pageX, n = d.pageY, p = parseInt(a(this)[0].style.marginLeft), o = a(this).siblings(".scroll-right").width()
                ...
                if (s && 0 != q) {
                    ...
                    var d = p + m - k;
                    if (d = 0 > d ? d : 0, 0 == r) {
                        var e = {x: k, y: l}, f = {x: m, y: n}, g = t(e, f);
                        if (r = 1, parseInt(g) < -30 || parseInt(g) > 30) q = !1; else {
                            if (parseInt(a(this)[0].style.marginLeft) > 0)return;
                            a(this).css({"-webkit-transition-duration": "0s", marginLeft: d})
                        }
                    } else {
            ...
            var c = this, d = a("<ul></ul>");
            for (var e in b) {
                var f = a(groupLineTmp({data: b[e], option: c.option, index: e}));
                d.append(f), d.append(c.buildListview(b[e].items, e))
            }
            return d
        }, add: function (b, c) {
            var d = this, e = d.buildListview(b);
            if (c || 1 == c) d.ele.append(e); else {
                var f = d.ele.children().first();
                f.prepend(e)
            }
            return a(".scroll-right").on("tap", function (c) {
                var d = this, e = a(d).data("index"), f = a(".scroll-right").length;
            ...
            f = appcan.view.template(getTpl(tpl));
        }
