...
appcan.ready(function(){
    ...
    $('.add_note').click(function (){
        ...
        // var noteID = 'notID_' + $('#note .block-foot').length;
        // var picClass = 'div_upload_'+($('#note .noteClass').length+1);
        // var addNoteHTML = '<table class="table-input" id="' + noteID + '">'+
        var noteID = 'noteID_' + $('#note .block-foot').length;
        var picClass = 'div_upload_'+($('#note .noteClass').length+1);
        var addNoteHTML = '<table class="table-input memo noteClass" id="' + noteID + '">'+
                    '<tr>'+
                        ...
                        '<td style="width:10%;">'+
                            '<i class="add_note add-note icon iconfont icon-guanbi2" onclick="removeParent($(this),\'.table-input\',\'备注\')"></i>'+
                        '</td>'+
                    '</tr>'+
                    '<tr>'+
